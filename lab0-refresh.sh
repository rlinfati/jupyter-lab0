...
if [[ $(uname -m) == "x86_64" ]]; then
    ...
    #sudo podman build --tag rlinfati/jupyter-lab0:julia-999 github.com/rlinfati/jupyter-lab0 --file Dockerfile.JULIA --build-arg CPU_TARGET=generic --secret id=GUROBIWLS
